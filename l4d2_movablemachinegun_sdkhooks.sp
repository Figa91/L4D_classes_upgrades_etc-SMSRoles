...
public OnPluginStart()
{
	...
	RegAdminCmd("sm_removeminigun", RemoveMini, ADMFLAG_ROOT, "Remove the minigun you aimed at");
...
bool g_bFinale()
{
	...
	if (StrEqual(mapname, "l4d_farm05_cornfield")			|| 
		...
		StrEqual(mapname, "l4d_sh12_theend")				||
		StrEqual(mapname, "l4d_sh_theend2")					||
		StrEqual(mapname, "l4d_sh_theend3")					||
		StrEqual(mapname, "l4d_sh_theend4")) return true;
	return false;
}